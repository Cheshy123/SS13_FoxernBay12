...
/obj/machinery/suit_cycler
	...
	var/list/species = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_UNATHI,SPECIES_ETHARI)
...
/obj/machinery/suit_cycler/engineering
	...
	species = list(SPECIES_HUMAN,SPECIES_ETHARI,SPECIES_SKRELL,SPECIES_UNATHI) //Add Unathi when sprites exist for their suits.
...
/obj/machinery/suit_cycler/mining
	...
	species = list(SPECIES_HUMAN,SPECIES_ETHARI,SPECIES_SKRELL,SPECIES_UNATHI)
