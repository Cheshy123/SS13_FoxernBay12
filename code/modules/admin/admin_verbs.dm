...
/client/proc/editappear()
	...
	if(!istype(M, /mob/living/carbon/human))
		...
		return
	switch(alert("Are you sure you wish to edit this mob's appearance? Skrell, Unathi, Vox and Etharian can result in unintended consequences.",,"Yes","No"))
		if("No")
			return
	...
	var/new_skin = input("Please select body color. This is for Etharian, Unathi, and Skrell only!", "Character Generation") as color
	if(new_skin)
