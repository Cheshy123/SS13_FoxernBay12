...
/obj/item/clothing/suit/storage/toggle/hoodie/cti
	...
	desc = "A warm, black sweatshirt.  It bears the letters В‘CTIВ’ on the back, a lettering to the prestigious university in Tau Ceti, Ceti Technical Institute.  There is a blue supernova embroidered on the front, the emblem of CTI."
...
/obj/item/clothing/suit/storage/toggle/hoodie/mu
	...
	desc = "A warm, gray sweatshirt.  It bears the letters В‘MUВ’ on the front, a lettering to the well-known public college, Mariner University."
