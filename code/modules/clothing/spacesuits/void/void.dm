...
/obj/item/clothing/head/helmet/space/void
	...
	sprite_sheets = list(
		...
		SPECIES_ETHARI = 'icons/mob/species/etharian/helmet.dmi',
		SPECIES_SKRELL = 'icons/mob/species/skrell/helmet.dmi',
		)
	sprite_sheets_obj = list(
		SPECIES_UNATHI = 'icons/obj/clothing/species/unathi/hats.dmi',
		SPECIES_ETHARI = 'icons/obj/clothing/species/etharian/hats.dmi',
...
/obj/item/clothing/suit/space/void
	...
	sprite_sheets = list(
		...
		SPECIES_ETHARI = 'icons/mob/species/etharian/suit.dmi',
		SPECIES_SKRELL = 'icons/mob/species/skrell/suit.dmi',
		)
	sprite_sheets_obj = list(
		SPECIES_UNATHI = 'icons/obj/clothing/species/unathi/suits.dmi',
		SPECIES_ETHARI = 'icons/obj/clothing/species/etharian/suits.dmi',
